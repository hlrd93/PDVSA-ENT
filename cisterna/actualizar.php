...
if (isset($_POST['fecha_cisterna_estado'])) {
	...
	$cisterna->id_cisterna = $_POST['id_cisterna'];
	...
	$ruta4 = "../img/cisterna/seguro/". $_POST['placa_cisterna'] . "_seguro.pdf";
	$ruta5 = "../img/cisterna/titulo/". $_POST['placa_cisterna'] . "_titulo.pdf";
