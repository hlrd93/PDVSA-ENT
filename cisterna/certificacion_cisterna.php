...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Cisternas <small>Ficha Técnica</small>
                </h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">
                        <img src="../img/cisterna.png" height="30px" alt="Truck"> Ficha Técnica de Cisternas
                    </li>
                </ol>
            </div>
        </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#form1').submit(function (e) {
                    ...
                    $.ajax({
                        url: '../cisterna/certificacion.php',
                        type: 'POST',
                        data: {
                            placa: placa,
                            serial: serial
        ...
        <h3>Buscar por <small>Placa o Seriales de Carroceria</small></h3>
        <hr>
        <!-- Placas y Seriales -->
        <div class="row">
